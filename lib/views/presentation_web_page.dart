...
class _PresentationWebPageState extends State<PresentationWebPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      precacheImage(const AssetImage("assets/presentation_page_user_example_5.jpg"), context);
    });
    super.initState();
  }
                    ...
                    child: Padding(
                      ...
                      child: InfiniteAutomaticScroll(
                        ...
                        items: [
                          ...
                          ExampleImageToScroll(imagePath: "assets/presentation_page_user_example_5.jpg", onTap: _pauseScrollAndShowImage),
                        ],
                      ),
                    ),
                  ),
